"""VER-MOK-011 oracle 5: enumerate a package's public interface from its sources.

Usage, from the repository root:

    python docs/engineering/simulation/evidence/WO-MOK-011/analysis/interface.py <src-file> ...
