"""VER-MOK-010 oracle 3: turn a `cargo test` log into a target-qualified census of test names.

Usage, from the repository root:

    python docs/engineering/simulation/evidence/WO-MOK-010/analysis/census.py <cargo-test-log> <out.txt>
