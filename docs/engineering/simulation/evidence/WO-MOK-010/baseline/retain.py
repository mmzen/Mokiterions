"""VER-MOK-010 oracle 1: retain the part of a 110 MB capture that a reviewer needs.

Usage, from the repository root:

    python docs/engineering/simulation/evidence/WO-MOK-010/baseline/retain.py \
