...
#
#     bash docs/engineering/simulation/evidence/WO-MOK-019/measure-sizes.sh \
...

{
  ...
  echo "# command: bash docs/engineering/simulation/evidence/WO-MOK-019/measure-sizes.sh \\"
