...
Usage, from the repository root:
    ...
    python docs/engineering/simulation/evidence/WO-MOK-019/analysis/entropy.py \
...
def main():
    ...
    lines = [
        ...
        '#',
        '# work order:  WO-MOK-019',
        f'# commit:      {COMMIT} (working tree, WO-MOK-019 implementation)',
        ...
        '#',
        '# This is the artifact WO-MOK-019 declares as `entropy.txt`. It carries five parts:',
        '#',
