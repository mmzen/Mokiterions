...
Usage, from the repository root:
    ...
    python docs/engineering/simulation/evidence/WO-MOK-019/analysis/validate.py \
...
def main():
    ...
    lines = [
        ...
        '# command: python docs/engineering/simulation/evidence/WO-MOK-019/analysis/validate.py '
        '<capture-dir> <output-file>',
        '#',
