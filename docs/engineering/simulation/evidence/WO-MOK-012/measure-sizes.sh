...
#
#     bash docs/engineering/simulation/evidence/WO-MOK-012/measure-sizes.sh \
...

{
  ...
  echo "# command: bash docs/engineering/simulation/evidence/WO-MOK-012/measure-sizes.sh \\"
