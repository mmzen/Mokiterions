"""VER-MOK-012 row 248: turn one `cargo test` log into a target-qualified census of test names.

Usage, from the repository root:

    python docs/engineering/simulation/evidence/WO-MOK-012/analysis/test-census.py \
