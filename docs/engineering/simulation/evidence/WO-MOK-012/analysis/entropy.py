...
Usage, from the repository root:
    ...
    python docs/engineering/simulation/evidence/WO-MOK-012/analysis/entropy.py \
...
def main():
    ...
    lines = [
        ...
        '#',
        '# work order:  WO-MOK-012',
        f'# commit:      {COMMIT} (working tree, WO-MOK-012 implementation)',
        ...
        '#',
        '# This is the artifact WO-MOK-012 declares as `entropy.txt`. It carries five parts:',
        '#',
