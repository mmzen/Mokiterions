...
Usage, from the repository root:
    ...
    python docs/engineering/simulation/evidence/WO-MOK-012/analysis/reconstruct.py \
...
def main():
    ...
    lines = [
        ...
        '# command: python docs/engineering/simulation/evidence/WO-MOK-012/analysis/reconstruct.py '
        '<capture-dir> <output-file>',
        '#',
