...
`VER-MOK-012` retains "the constructed-state resolution tables for damage, energy cost,
...
# `VER-MOK-012`'s retention clause asks for, and checking it is the reason they are transcribed
