"""VER-MOK-012 oracle 5: the per-identifier series, the correlations, and the turn-position bound.

Usage, from the repository root:

    python docs/engineering/simulation/evidence/WO-MOK-012/analysis/identifier.py \
