"""VER-MOK-016's long-horizon oracle, second half: the retained state no stream shows.

Usage, from the repository root, on Windows:

    python docs/engineering/simulation/evidence/WO-MOK-016/analysis/peak.py
    python docs/engineering/simulation/evidence/WO-MOK-016/analysis/peak.py --control
