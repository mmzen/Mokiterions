"""VER-MOK-016's long-horizon oracle: what a 10,000-tick run completes with, and what it retains.

Usage, from the repository root:

    python docs/engineering/simulation/evidence/WO-MOK-016/analysis/horizon.py <capture-dir> \
        --against docs/engineering/simulation/evidence/WO-MOK-016/post/social-manifest.txt
    python docs/engineering/simulation/evidence/WO-MOK-016/analysis/horizon.py <capture-dir> \
        --control <name>
...
def provenance_failures(runs: dict, path: str) -> tuple:
    ...
    `VER-MOK-016`'s released `social` capture is 1,000 ticks at these seeds and densities, so a
