...
`VER-MOK-016`'s `REQ-MOK-060` row asks for a comparison "line for line against the
...
#
# Expectations are `same` for the four regions VER-MOK-016 requires to be unchanged, and
# for the two waste conditions -- those two because REQ-MOK-060 is unimplemented under the
