"""VER-MOK-016 oracle 4: whole runs under `social`, replayed from the released event stream.

Usage, from the repository root:

    python docs/engineering/simulation/evidence/WO-MOK-016/analysis/runs.py <capture-dir>
...
`VER-MOK-016` retains "the branch distribution under `social` per seed -- how often each of
`REQ-MOK-057`'s five branches fired", and the amendment of 2026-08-20 made those five six. Five of the
...
`VER-MOK-016` asks for encounters per seed and strikes per encounter, and neither is defined by the
