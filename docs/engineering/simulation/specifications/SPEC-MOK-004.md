...
rather than 32, as corrected for `WO-MOK-011`. Two tests arrive:
...
As corrected for `WO-MOK-011`, the observer's total is **120** and the engine's is **85**, so the workspace's is
