...
this rule; the 2026-08-21 row of the amendment record records that as a `WO-MOK-016` defect and corrects it here.
...
`master` reached 49 without correcting this rule, which is the second uncorrected `WO-MOK-016` figure this merge
measures and which the 2026-08-21 row of the amendment record records with the first. Rule 6's three figures are
